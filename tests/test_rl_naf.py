...
def test_naf():
    ...
    trainer = RawTrainer(env, agent, NaiveReplayMemory(buffer_size=5000), episode=300, learn_freq=1, learn_start=5000,
                         batch_size=32, update_time=-1, render=True, verbose=1)
    trainer.train()
